...
const sanitizeBackgroundWallpaper = (
  backgroundWallpaper?: NewTab.BackgroundWallpaper
  ...
  switch (action.type) {
    case types.NEW_TAB_SET_INITIAL_DATA:
      ...
      if (initialDataPayload.wallpaperData) {
        let backgroundWallpaper = sanitizeBackgroundWallpaper(
    ...
    case types.NEW_TAB_PREFERENCES_UPDATED:
      ...
      if (shouldChangeBackgroundImage && !newState.backgroundWallpaper) {
        newState.backgroundWallpaper = undefined
      }
