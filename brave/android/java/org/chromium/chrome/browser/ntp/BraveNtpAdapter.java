...
public class BraveNtpAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof StatsViewHolder) {
            ...
            if (mNtpImage == null && mSponsoredLogo == null) {
                ViewGroup.LayoutParams layoutParams = imageCreditViewHolder.itemView.getLayoutParams();
                if (layoutParams != null) {
                    layoutParams.height = 0;
                    imageCreditViewHolder.itemView.setLayoutParams(layoutParams);
                }
                imageCreditViewHolder.itemView.setVisibility(View.GONE);
            ...
            imageCreditViewHolder.itemView.setVisibility(View.VISIBLE);
            ...
            if (mRecyclerViewHeight > 0) {
                LinearLayout.LayoutParams layoutParamsCredit =
                ...
                layoutParamsCredit.setMargins(0, mTopMarginImageCredit, 0, 0);

                imageCreditViewHolder.mNtpImageCreditLayout.setLayoutParams(layoutParamsCredit);
            }
    ...
    public void setSponsoredLogo(@Nullable Wallpaper wallpaper, @Nullable Bitmap sponsoredLogo) {
        mWallpaper = wallpaper;
        mSponsoredLogo = sponsoredLogo;
        notifyItemChanged(getStatsCount() + getTopSitesCount() + getNewContentCount());
    }

    public void setNtpImage(@Nullable NTPImage ntpImage) {
        mNtpImage = ntpImage;
        notifyItemChanged(getStatsCount() + getTopSitesCount() + getNewContentCount());
    }
