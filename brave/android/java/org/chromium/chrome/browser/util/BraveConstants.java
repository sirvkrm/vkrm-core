...
public final class BraveConstants {
    ...
    public static final String BRAVE_PRODUCTION_PACKAGE_NAME = "com.vkrm.browser.chromium";
    public static final String BRAVE_BETA_PACKAGE_NAME = "com.vkrm.browser.chromium.beta";
    public static final String BRAVE_NIGHTLY_PACKAGE_NAME = "com.vkrm.browser.chromium.nightly";
    public static final String BRAVE_DEBUG_PACKAGE_NAME = "com.vkrm.browser.chromium";
