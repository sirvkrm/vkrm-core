...
public class BraveSearchEngineUtils {
    private static final String GOOGLE_SHORT_NAME = "Google";
    ...
    private static void initializeDSEPrefs(Profile profile) {
        ...
        if (notInitialized.equals(
            ...
            TemplateUrl googleTemplateUrl = getGoogleTemplateUrl(templateUrlService);
            TemplateUrl templateUrl =
                    googleTemplateUrl != null
                            ? googleTemplateUrl
                            : templateUrlService.getDefaultSearchEngineTemplateUrl();
            String defaultSearchEngineName = templateUrl.getShortName();
    ...
    private static @Nullable TemplateUrl getGoogleTemplateUrl(
            TemplateUrlService templateUrlService) {
        for (TemplateUrl templateUrl : templateUrlService.getTemplateUrls()) {
            if (GOOGLE_SHORT_NAME.equalsIgnoreCase(templateUrl.getShortName())) {
                return templateUrl;
            }

            String keyword = templateUrl.getKeyword().toLowerCase(Locale.US);
            String url = templateUrl.getURL().toLowerCase(Locale.US);
            if (keyword.contains("google") || url.contains("google.")) {
                return templateUrl;
            }
        }
        return null;
