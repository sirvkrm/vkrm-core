...
Config.prototype.buildArgs = function () {
  ...
  if (this.targetOS === 'android') {
    ...
    if (!this.isReleaseBuild()) {
      ...
      args.chrome_public_manifest_package = 'com.vkrm.browser.chromium'
    } else if (this.channel === '') {
      args.android_channel = 'stable'
      args.chrome_public_manifest_package = 'com.vkrm.browser.chromium'
    } else if (this.channel === 'beta') {
      args.chrome_public_manifest_package = 'com.vkrm.browser.chromium.beta'
    } else if (this.channel === 'dev') {
      args.chrome_public_manifest_package = 'com.vkrm.browser.chromium.dev'
    } else if (this.channel === 'nightly') {
      args.android_channel = 'canary'
      args.chrome_public_manifest_package = 'com.vkrm.browser.chromium.nightly'
    }
